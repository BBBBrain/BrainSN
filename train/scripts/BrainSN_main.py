...
from configuration_brainsn import BrainsnConfig
...
class BrainSNEmbeddings(ViTMAEEmbeddings):
...
class BrainSNEncoder(ViTMAEEncoder):
    def __init__(self, config):
        super().__init__(config)
...
class BrainSNModel(ViTMAEModel):
    def __init__(self, config):
        super().__init__(config)
        self.embeddings = BrainSNEmbeddings(config)  
        self.encoder = BrainSNEncoder(config)
...
class BrainSNDecoder(ViTMAEDecoder):
...
class BrainSNForPretraining(ViTMAEForPreTraining):
  
    def __init__(self, config):
        super().__init__(config)
        self.vit = BrainSNModel(config)
        self.decoder = BrainSNDecoder(
